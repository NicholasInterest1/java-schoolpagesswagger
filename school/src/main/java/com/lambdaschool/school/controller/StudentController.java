...
public class StudentController {
    ...
    public ResponseEntity<?> listAllStudents(HttpServletRequest request, @PageableDefault(page = 0, size = 3, sort = "studname") Pageable pageable) {
    ...
    public ResponseEntity<?> getStudentById(HttpServletRequest request, @PathVariable Long StudentId) {
        logger.warn(request.getMethod().toUpperCase() + " " + request.getRequestURI() + " accessed");
    ...
    @GetMapping(value = "/student/namelike/{name}",
            produces = {"application/json"})
    public ResponseEntity<?> getStudentByNameContaining(HttpServletRequest request, @PathVariable String name) {
        logger.warn(request.getMethod().toUpperCase() + " " + request.getRequestURI() + " accessed");
    ...
    @PostMapping(value = "/Student",
            ...
            produces = {"application/json"})
    public ResponseEntity<?> addNewStudent(HttpServletRequest request, @Valid @RequestBody Student newStudent) throws URISyntaxException {
    ...
    public ResponseEntity<?> updateStudent(HttpServletRequest request, @RequestBody Student updateStudent, @PathVariable long Studentid) {
    ...
    public ResponseEntity<?> deleteStudentById(HttpServletRequest request, @PathVariable long Studentid) {
